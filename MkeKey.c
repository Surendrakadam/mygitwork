...
// Check log file directory ends with backslash or forward , if not add it
  ...
  sprintf(sss_rrrr_timestamp,"%s_%d_%d_%d_%d_%d_%d",sss_rrrr_log_file,YYYY,MM,DD,H24,MI,SS);
