...
# Application   : 42_507_File_Stat.pl
# Client        : Internal
...
sub sGetParameter {
   ...
   if ( ! $parameters -> getOptions ( $p_GetOptions , 'Usage: 42_507_File_Stat.pl [options]' ) ) {
      exit ( -1 ) ;                                             # Failure.
   }
...
=head3 Fields
  ...
  17. Count of valid email addresses field as per field number
      I defined a regex which can take multiple email ids. 
...
=head2 Technical
 ...
 Procedure Name   - 42_507_File_Stat.pl
...
=head3 Different examples of run parameter to run a procedure:
 ...
 perl 42_507_File_Stat.pl -i input.txt -f PIPE -e DOUBLEQUOTE -d  -o input_txt_filestatistics.tsv

 perl 42_507_File_Stat.pl -i input.txt -f PLUS -e DOUBLEQUOTE -o input_txt_filestatistics.tsv

 perl 42_507_File_Stat.pl -i input.txt -f CLOSEBRACKET -o input_txt_filestatistics.tsv

 perl 42_507_File_Stat.pl -i input.txt -f QUESTION -e DOUBLEQUOTE

 perl 42_507_File_Stat.pl -i input.txt -f STOP

 perl 42_507_File_Stat.pl -i input.txt -f STOP -t @#z

 perl 42_507_File_Stat.pl -i input.txt -f STOP -t *

 perl 42_507_File_Stat.pl -i input.txt -f STOP -c

 perl 42_507_File_Stat.pl -i E:\folder1\folder2\input.txt -f SEMICOLON
